...
3. **Giao diện Chi Tiết Phim Sắp Chiếu, Phim Đang Chiếu**
   ...
   <img src="Office/f3.jpg" alt="Phim sắp chiếu" width="200" style="margin-right:50px;"/>
...
<p float="left">
  <img src="Office/f11.jpg" alt="Phim sắp chiếu" width="200" style="margin-right:50px;"/>
  <img src="Office/f13.jpg" alt="Phim sắp chiếu" width="200" style="margin-right:50px;"/>
...
<p float="left">
  <img src="Office/f20.jpg" alt="Phim sắp chiếu" width="200" style="margin-right:50px;"/>
  <img src="Office/f15.jpg" alt="Phim sắp chiếu" width="200" style="margin-right:50px;"/>
...
| 16  | Người dùng | TC_USER_016  | Cập nhật thông tin người dùng | 1. . Đăng nhập<br>2. Thông tin tài khoản<br>3. Thay đổi thông tin | Giới tính: Nam<br>Giới tính mới: Nữ     
